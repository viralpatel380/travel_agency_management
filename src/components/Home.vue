          ...
          <div class="user-list">
            <div class="columns">
              ...
              <div class="column is-4 right">
                <router-link class="button is-info" to="/user">View Details</router-link>
              </div>
            </div>
          </div>
          ...
          <div class="columns">
            <div class="column is-8">
              ...
              <div class="inner">
                ...
                <div class="right">
                  <p class="user-list__sub"><strong>City</strong>: {{person.city}}</p>
                </div>
              </div>
            </div>
            <div class="column is-4 right">
              <router-link class="button is-info" v-bind:to="{ name: 'view-contact', params: { person: person.slug }}">View Details</router-link>
            </div>
          </div>
        </div>
      </div>
